...
# ====================================================
# Nftables 端口限速交互式管理脚本 (终极优化版)
# 特性: IPv4/IPv6双栈、防TCP断流、Docker兼容、智能防呆
# ====================================================
...
while true; do
    ...
    case $choice in
        ...
        5) stop_rules ;;
        6) menu_status ;;
        7) systemctl enable port-limiter.service; echo -e "${GREEN}✅ 已设置开机自启。${NC}" ;;
        8) systemctl disable port-limiter.service; echo -e "${YELLOW}✅ 已取消开机自启。${NC}" ;;
